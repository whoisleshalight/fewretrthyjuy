...
*/    var getOwnPropertySymbols = Object.getOwnPropertySymbols;
    ...
    window.addEventListener("load", (function(e) {
        setTimeout((() => {
            ...
            script_scroll.on("scroll", (obj => {
                if (obj.scroll.y >= 100) document.querySelector(".go-top").classList.add("goo"); else document.querySelector(".go-top").classList.remove("goo");
            }));
